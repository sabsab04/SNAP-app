                    ...
                    try {
                        ...
                        if (userId != null) {
                            ...
                            if (profiloUtente.Ruolo == "psicologo") {
                                val intentPsicologo = Intent(this@MainActivity2, HomeActivity::class.java)
                                startActivity(intentPsicologo)
                            } else {
                                // L'utente normale va finalmente alla tua HomeActivity!
                                val intentUtente = Intent(this@MainActivity2, HomeActivity::class.java)
